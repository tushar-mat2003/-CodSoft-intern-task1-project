        ...
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            <Link to='/' className='text-blue-600 font-bold text-xl'>
              Job<span className='text-[#DB00FD]'>Finder</span>
            </Link>
          </div>
          ...
          <div className='hidden lg:block'>
            {!user?.token ? (
              <Link to='/'>
                <CustomButton
                  title='Sign Up'
                  containerStyles='text-white py-1.5 px-5 focus:outline-none bg-[#DB00FD] hover:text-white hover:scale-125 ease-in-out duration-300 rounded-full text-base border border-white'
                />
              </Link>
            ) : (
              <div>
          ...
          <div className='w-full py-10'>
            {!user?.token ? (
              <a href='/'>
                <CustomButton
                  title='Sign Up'
                  containerStyles={`text-[#DB00FD] py-1.5 px-5 focus:outline-none hover:bg-[#1ADFA6] hover:text-white rounded-full text-base border border-[#1ADFA6]`}
                />
              </a>
            ) : (
              <div>
